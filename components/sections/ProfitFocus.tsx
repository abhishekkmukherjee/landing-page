    ...
    <section className="section pb-20">
      <div className="mx-auto max-w-6xl">
        <div className="relative overflow-hidden rounded-3xl border border-subtle bg-surface p-8 md:p-10">
          <div className="absolute -right-16 top-0 h-52 w-52 rounded-full bg-aurora/25 blur-3xl motion-safe:animate-drift" />
          <div className="absolute -left-20 bottom-0 h-52 w-52 rounded-full bg-ember/25 blur-3xl motion-safe:animate-float" />
